...
# -------------------QT Player vs QT Player--------------------------------Q TABLE STUFF--------------------------------


qtable = {}

#filename = 'v3Q_TABLE_4_QTvQT_20k.pickle'
#filename = 'test_god_vs_QT.pickle'
#filename = 'test_RA_vs_QT.pickle'
#filename = 'v3Q_TABLE_4_QTvHE_30kB.pickle'      # gets ass kicked.
#filename = 'v3Q_TABLE_4_QTvRA_20kB.pickle'
filename = 'v3Q_TABLE_4_QTvRA_20kC.pickle'
